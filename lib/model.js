...
class Model {
  ...
  set createdAt(value) {
    ...
    this.attributes.created_at = value.toDate();
  }
   ...
   */
  get createdAt() {
    return utc(this.attributes.created_at);
  }
  ...
  set updatedAt(value) {
    ...
    this.attributes.updated_at = value.toDate();
  }
   ...
   */
  get updatedAt() {
    return utc(this.attributes.updated_at);
  }
